...
const HR = () => {
  ...
  function handleGoogleSignup() {
    handleGoogleSignUp()
      .then((res) => {
        const UserInfo = {
          displayName: res.user.displayName || "HR Manager",
      ...
      <StyledWrapper>
        <div className="container">
          <div className="flex flex-col justify-center items-center">
            {" "}
            <Logo></Logo>
            <div className="heading">Join as HR Manager </div>
          </div>
          <form onSubmit={handleSubmit(hrRegister)} className="form space-y-3">
